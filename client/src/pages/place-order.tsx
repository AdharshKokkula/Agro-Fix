...
export default function PlaceOrderPage() {
  ...
  const { cart, clearCart, getCartTotal, getItemCount } = useCart();
  ...
  const createOrderMutation = useMutation({
    mutationFn: async (data: OrderFormData) => {
      ...
      const orderData = {
        ...data,
        items: cartItems,
        totalAmount: getCartTotal() * 100, // Convert to cents
      };
      ...
      content: (
        <div>
            ...
            {getItemCount() === 0 ? (
              ...
              <div className="border rounded-lg">
                ...
                <div className="p-4 bg-gray-50 border-t border-gray-200">
                  ...
                  <div className="flex justify-between text-lg font-bold">
                    <span>Total</span>
                    <span>{formatCurrency(getCartTotal() + 200)}</span>
                  </div>
                </div>
              </div>
            )}
          ...
          <Button 
            type="button"
            className="w-full"
            disabled={getItemCount() === 0 || createOrderMutation.isPending}
