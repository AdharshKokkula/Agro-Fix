    ...
    <>
            ...
            <div className="md:w-1/2 mb-8 md:mb-0">
              ...
              <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                ...
                <Link href="/place-order">
                  <Button variant="outline" className="border-2 border-white text-white hover:bg-white/20 w-full sm:w-auto font-medium px-6 py-2.5 transition-all">
                    Place Bulk Order
                  </Button>
                </Link>
              </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-3 text-center">Featured Products</h2>
            <div className="w-20 h-1 bg-primary-500 rounded mb-6"></div>
            <p className="text-gray-600 text-lg text-center max-w-2xl">Check out some of our most popular items available for bulk orders at competitive wholesale prices.</p>
          </div>
          
          {isLoading ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              {[...Array(4)].map((_, i) => (
                <Card key={i} className="h-80 animate-pulse bg-white border border-gray-100 rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-600 mb-16 text-center max-w-2xl mx-auto text-lg">Our simple process makes ordering bulk fresh produce easy and efficient for your business.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 relative">
            ...
            <div className="text-center relative group hover:shadow-lg transition-all duration-300 p-8 rounded-xl border border-transparent hover:border-primary-100">
              ...
              <p className="text-gray-600 leading-relaxed">Explore our wide range of fresh vegetables and fruits available for bulk ordering at competitive prices.</p>
            </div>
            ...
            <div className="text-center relative group hover:shadow-lg transition-all duration-300 p-8 rounded-xl border border-transparent hover:border-primary-100">
              ...
              <p className="text-gray-600 leading-relaxed">Select the items you need, specify quantities, and complete your order with delivery details.</p>
            </div>
            ...
            <div className="text-center relative group hover:shadow-lg transition-all duration-300 p-8 rounded-xl border border-transparent hover:border-primary-100">
              ...
              <p className="text-gray-600 leading-relaxed">Your order is delivered directly to your specified location, fresh and ready to use.</p>
            </div>
          </div>
